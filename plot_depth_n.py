...
def plot_depth_n( value="temp",target_pressure=120, time_highlight=None, \
    ...
    #files=["noora_6902020_20170828072009212test.nc"]
    ...
    #Just a test plot to check that data is more or less right
    #plt.clf();
    #for i in range(30):
    #   plt.plot(oxyg_a[i,:],-1*press_a[i,:])
    ...
    #        if(diff<3): #the depth does exist
    ...
    #    plot_result=plt.plot(time_ax,time_ax)
        plot_result=plt.plot(time_ax,np.ma.masked_invalid(data_set),color)
        print file_n

...
#    start=mp.dates.datetime.datetime(2013,10,20)
#    end=mp.dates.datetime.datetime(2013,11,3)
    ...
    if(draw_images):
        ...
        lon30km=30.0/((np.cos(57.32)*6371.*np.pi*2.0)/360.)
        lat30km=30.0/((6371.*np.pi*2.0)/360.)
        x,y=bmap(20.05+np.sin(angle)*lon30km,57.32+np.cos(angle)*lat30km)

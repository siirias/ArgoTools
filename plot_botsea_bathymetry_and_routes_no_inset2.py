...
lon_min=19.00;lat_min=60.50;lon_max=22.0;lat_max=62.0; #as reviewer suggester
...
plt.savefig('petranc//ArgoRoutesSmallArea2016v2.png' ,facecolor='w',dpi=600)
plt.savefig('petranc//ArgoRoutesSmallArea2016v2.pdf' ,facecolor='w',dpi=600)
plt.savefig('petranc//ArgoRoutesSmallArea2016v2.svg' ,facecolor='w',dpi=600)
plt.savefig('petranc//ArgoRoutesSmallArea2016v2.eps' ,facecolor='w',dpi=600)